    ...
    <div className="lg:w-3/4 flex flex-col justify-center items-center px-4 lg:px-0">
      ...
      <div className="flex flex-col lg:flex-row gap-x-10 mt-10">
        <div className="flex flex-col gap-2">
          ...
          <h1 className="text-[16px] flex gap-2">Địa chỉ: <h1 className="font-semibold text-[rgb(var(--primary-rgb))]">121, Nguyễn Văn Trường, Long Tuyền, Bình Thủy, TP. Cần Thơ</h1></h1>
          <h1 className="text-[16px] flex gap-2">Email: <h1 className="font-semibold text-[rgb(var(--primary-rgb))]">info@ecoka.vn</h1></h1>
        </div>
        <div className="flex flex-col gap-2">
